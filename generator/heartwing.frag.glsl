...
{
    float animWings = 0.01 * texture(iChannel0, vec2(0.5, 0.5)).r * cos(iTime * 0.5);
    float animFlap = 0.005 * texture(iChannel0, vec2(0.5, 0.5)).r * sin(iTime * 1.0);    
	...
	float juliay = cos(timeVal * 0.213) * (0.022 + animFlap + 0.05 * texture(iChannel0, vec2(0.5, 0.5)).r) + 5.66752 - juliax * 1.5101;//+(fragCoord.y*0.0001);// or 5.7
